...
AsyncMqttClient::AsyncMqttClient(IAsyncClient &client)
:_client(client)
,_connected(false)
...
, _nextPacketId(1) {
  _client.onConnect([](void* obj, IAsyncClient* c) { (static_cast<AsyncMqttClient*>(obj))->_onConnect(c); }, this);
  _client.onDisconnect([](void* obj, IAsyncClient* c) { (static_cast<AsyncMqttClient*>(obj))->_onDisconnect(c); }, this);
  _client.onError([](void* obj, IAsyncClient* c, int8_t error) { (static_cast<AsyncMqttClient*>(obj))->_onError(c, error); }, this);
  _client.onTimeout([](void* obj, IAsyncClient* c, uint32_t time) { (static_cast<AsyncMqttClient*>(obj))->_onTimeout(c, time); }, this);
  _client.onAck([](void* obj, IAsyncClient* c, size_t len, uint32_t time) { (static_cast<AsyncMqttClient*>(obj))->_onAck(c, len, time); }, this);
  _client.onData([](void* obj, IAsyncClient* c, void* data, size_t len) { (static_cast<AsyncMqttClient*>(obj))->_onData(c, static_cast<char*>(data), len); }, this);
  _client.onPoll([](void* obj, IAsyncClient* c) { (static_cast<AsyncMqttClient*>(obj))->_onPoll(c); }, this);
...
/* TCP */
void AsyncMqttClient::_onConnect(IAsyncClient* client) {
  (void)client;
...
void AsyncMqttClient::_onDisconnect(IAsyncClient* client) {
  (void)client;
...
void AsyncMqttClient::_onError(IAsyncClient* client, int8_t error) {
  (void)client;
  (void)error;
  // _onDisconnect called anyway
}

void AsyncMqttClient::_onTimeout(IAsyncClient* client, uint32_t time) {
  (void)client;
  (void)time;
  // disconnection will be handled by ping/pong management
}

void AsyncMqttClient::_onAck(IAsyncClient* client, size_t len, uint32_t time) {
  (void)client;
  (void)len;
  (void)time;
}

void AsyncMqttClient::_onData(IAsyncClient* client, char* data, size_t len) {
  (void)client;
...
void AsyncMqttClient::_onPoll(IAsyncClient* client) {
