...
void AsyncTCPbuffer::_attachCallbacks() {
    ...
    _client->onPoll([](void *obj, IAsyncClient* c) {
    ...
    _client->onAck([](void *obj, IAsyncClient* c, size_t len, uint32_t time) {
        DEBUG_ASYNC_TCP("[A-TCP] onAck\n");
        ((AsyncTCPbuffer*)(obj))->_sendBuffer();
    }, this);

    _client->onDisconnect([](void *obj, IAsyncClient* c) {
    ...
    _client->onData([](void *obj, IAsyncClient* c, void *buf, size_t len) {
        AsyncTCPbuffer* b = ((AsyncTCPbuffer*)(obj));
        b->_rxData((uint8_t *)buf, len);
    }, this);

    _client->onTimeout([](void *obj, IAsyncClient* c, uint32_t time){
