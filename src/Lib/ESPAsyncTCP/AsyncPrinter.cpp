...
int AsyncPrinter::connect(IPAddress ip, uint16_t port){
  ...
  _client->onConnect([](void *obj, IAsyncClient *c){ ((AsyncPrinter*)(obj))->_onConnect(c); }, this);
...
void AsyncPrinter::_onConnect(IAsyncClient *c){
  if(_tx_buffer != NULL){
    cbuf *b = _tx_buffer;
    _tx_buffer = NULL;
    delete b;
...
void AsyncPrinter::_attachCallbacks(){
  _client->onPoll([](void *obj, IAsyncClient* c){ ((AsyncPrinter*)(obj))->_sendBuffer(); }, this);
  _client->onAck([](void *obj, IAsyncClient* c, size_t len, uint32_t time){ ((AsyncPrinter*)(obj))->_sendBuffer(); }, this);
  _client->onDisconnect([](void *obj, IAsyncClient* c){ ((AsyncPrinter*)(obj))->_on_close(); delete c; }, this);
  _client->onData([](void *obj, IAsyncClient* c, void *data, size_t len){ ((AsyncPrinter*)(obj))->_onData(data, len); }, this);
}
